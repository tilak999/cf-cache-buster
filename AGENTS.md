...
- The `go.mod` must exist at the repo root with the correct module path (`github.com/tilak999/traefikplugin`).
...
- The test package is `traefikplugin_test` (external test package).
